 ...
 */
function virtualMachineExtensionImagesGetMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineExtensionImages.get(location, publisherName, typeParam, version);
        console.log(result);
    });
}
 ...
 */
function virtualMachineExtensionImagesGetMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
...
//# sourceMappingURL=virtualMachineExtensionImagesGetSample.js.map