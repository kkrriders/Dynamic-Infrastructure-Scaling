 ...
 */
function restorePointsDeleteMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.restorePoints.beginDeleteAndWait(resourceGroupName, restorePointCollectionName, restorePointName);
        console.log(result);
    });
}
 ...
 */
function restorePointsDeleteMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const resourceGroupName = "rgcompute";
...
//# sourceMappingURL=restorePointsDeleteSample.js.map