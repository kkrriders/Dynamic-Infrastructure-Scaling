 ...
 */
function getARestorePointCollectionButNotTheRestorePointsContainedInTheRestorePointCollection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.restorePointCollections.get(resourceGroupName, restorePointCollectionName);
        console.log(result);
    });
}
getARestorePointCollectionButNotTheRestorePointsContainedInTheRestorePointCollection().catch(console.error);
/**
 * This sample demonstrates how to The operation to get the restore point collection.
 *
 * @summary The operation to get the restore point collection.
 ...
 */
function getARestorePointCollectionIncludingTheRestorePointsContainedInTheRestorePointCollection() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const resourceGroupName = "myResourceGroup";
...
getARestorePointCollectionIncludingTheRestorePointsContainedInTheRestorePointCollection().catch(console.error);
//# sourceMappingURL=restorePointCollectionsGetSample.js.map