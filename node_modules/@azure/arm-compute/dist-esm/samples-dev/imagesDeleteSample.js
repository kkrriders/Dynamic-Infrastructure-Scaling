 ...
 */
function imagesDeleteMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.images.beginDeleteAndWait(resourceGroupName, imageName);
        console.log(result);
    });
}
 ...
 */
function imagesDeleteMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const resourceGroupName = "rgcompute";
...
//# sourceMappingURL=imagesDeleteSample.js.map