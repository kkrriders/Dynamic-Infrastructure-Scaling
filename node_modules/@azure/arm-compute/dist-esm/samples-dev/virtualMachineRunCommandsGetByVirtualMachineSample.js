...
function getARunCommand() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineRunCommands.getByVirtualMachine(resourceGroupName, vmName, runCommandName);
        console.log(result);
    });
}
getARunCommand().catch(console.error);
//# sourceMappingURL=virtualMachineRunCommandsGetByVirtualMachineSample.js.map