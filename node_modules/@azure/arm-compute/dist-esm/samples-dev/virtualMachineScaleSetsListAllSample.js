...
function virtualMachineScaleSetsListAllMaximumSetGen() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.virtualMachineScaleSets.listAll()), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
 ...
 */
function virtualMachineScaleSetsListAllMinimumSetGen() {
    var e_2, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const credential = new DefaultAzureCredential();
...
//# sourceMappingURL=virtualMachineScaleSetsListAllSample.js.map