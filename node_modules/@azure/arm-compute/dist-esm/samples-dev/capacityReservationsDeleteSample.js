 ...
 */
function capacityReservationsDeleteMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.capacityReservations.beginDeleteAndWait(resourceGroupName, capacityReservationGroupName, capacityReservationName);
        console.log(result);
    });
}
 ...
 */
function capacityReservationsDeleteMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const resourceGroupName = "rgcompute";
...
//# sourceMappingURL=capacityReservationsDeleteSample.js.map