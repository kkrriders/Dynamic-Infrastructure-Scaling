 ...
 */
function getVirtualMachineScaleSetVMRunCommands() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineScaleSetVMRunCommands.get(resourceGroupName, vmScaleSetName, instanceId, runCommandName);
        console.log(result);
    });
}
getVirtualMachineScaleSetVMRunCommands().catch(console.error);
//# sourceMappingURL=virtualMachineScaleSetVMRunCommandsGetSample.js.map