 ...
 */
function reapplyTheStateOfAVirtualMachine() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachines.beginReapplyAndWait(resourceGroupName, vmName);
        console.log(result);
    });
}
reapplyTheStateOfAVirtualMachine().catch(console.error);
//# sourceMappingURL=virtualMachinesReapplySample.js.map