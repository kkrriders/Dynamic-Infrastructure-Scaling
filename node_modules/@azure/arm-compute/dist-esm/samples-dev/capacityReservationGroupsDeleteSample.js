...
function capacityReservationGroupsDeleteMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.capacityReservationGroups.delete(resourceGroupName, capacityReservationGroupName);
        console.log(result);
    });
}
 ...
 */
function capacityReservationGroupsDeleteMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const resourceGroupName = "rgcompute";
...
//# sourceMappingURL=capacityReservationGroupsDeleteSample.js.map