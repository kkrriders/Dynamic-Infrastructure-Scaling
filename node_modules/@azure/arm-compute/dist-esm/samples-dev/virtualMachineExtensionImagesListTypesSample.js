 ...
 */
function virtualMachineExtensionImagesListTypesMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineExtensionImages.listTypes(location, publisherName);
        console.log(result);
    });
}
 ...
 */
function virtualMachineExtensionImagesListTypesMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const location = "aaaa";
...
//# sourceMappingURL=virtualMachineExtensionImagesListTypesSample.js.map