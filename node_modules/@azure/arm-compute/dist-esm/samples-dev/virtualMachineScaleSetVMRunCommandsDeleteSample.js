 ...
 */
function deleteVirtualMachineScaleSetVMRunCommand() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineScaleSetVMRunCommands.beginDeleteAndWait(resourceGroupName, vmScaleSetName, instanceId, runCommandName);
        console.log(result);
    });
}
deleteVirtualMachineScaleSetVMRunCommand().catch(console.error);
//# sourceMappingURL=virtualMachineScaleSetVMRunCommandsDeleteSample.js.map