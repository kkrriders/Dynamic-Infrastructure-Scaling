...
function restartDedicatedHost() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.dedicatedHosts.beginRestartAndWait(resourceGroupName, hostGroupName, hostName);
        console.log(result);
    });
}
restartDedicatedHost().catch(console.error);
//# sourceMappingURL=dedicatedHostsRestartSample.js.map