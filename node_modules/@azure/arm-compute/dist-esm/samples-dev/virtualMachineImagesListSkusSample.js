 ...
 */
function virtualMachineImagesListSkusMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineImages.listSkus(location, publisherName, offer);
        console.log(result);
    });
}
 ...
 */
function virtualMachineImagesListSkusMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const location = "aaaa";
...
//# sourceMappingURL=virtualMachineImagesListSkusSample.js.map