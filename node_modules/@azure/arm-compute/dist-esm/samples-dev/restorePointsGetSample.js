...
function getARestorePoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.restorePoints.get(resourceGroupName, restorePointCollectionName, restorePointName);
        console.log(result);
    });
}
 ...
 */
function getRestorePointWithInstanceView() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const resourceGroupName = "myResourceGroup";
        const restorePointCollectionName = "rpcName";
...
//# sourceMappingURL=restorePointsGetSample.js.map