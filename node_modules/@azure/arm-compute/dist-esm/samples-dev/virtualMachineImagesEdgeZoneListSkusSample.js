 ...
 */
function virtualMachineImagesEdgeZoneListSkusMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineImagesEdgeZone.listSkus(location, edgeZone, publisherName, offer);
        console.log(result);
    });
}
 ...
 */
function virtualMachineImagesEdgeZoneListSkusMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
...
//# sourceMappingURL=virtualMachineImagesEdgeZoneListSkusSample.js.map