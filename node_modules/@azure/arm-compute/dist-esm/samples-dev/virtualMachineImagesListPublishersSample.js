 ...
 */
function virtualMachineImagesListPublishersMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const location = "aaaaa";
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.virtualMachineImages.listPublishers(location);
        console.log(result);
    });
}
 ...
 */
function virtualMachineImagesListPublishersMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
...
//# sourceMappingURL=virtualMachineImagesListPublishersSample.js.map