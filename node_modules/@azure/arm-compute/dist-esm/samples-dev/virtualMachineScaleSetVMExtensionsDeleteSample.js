 ...
 */
function deleteVirtualMachineScaleSetVMExtension() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineScaleSetVMExtensions.beginDeleteAndWait(resourceGroupName, vmScaleSetName, instanceId, vmExtensionName);
        console.log(result);
    });
}
deleteVirtualMachineScaleSetVMExtension().catch(console.error);
//# sourceMappingURL=virtualMachineScaleSetVMExtensionsDeleteSample.js.map