 ...
 */
function listExtensionsInVmssInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineScaleSetVMExtensions.list(resourceGroupName, vmScaleSetName, instanceId);
        console.log(result);
    });
}
listExtensionsInVmssInstance().catch(console.error);
//# sourceMappingURL=virtualMachineScaleSetVMExtensionsListSample.js.map