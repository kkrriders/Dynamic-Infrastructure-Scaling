...
function virtualMachineScaleSetVMSDeallocateMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineScaleSetVMs.beginDeallocateAndWait(resourceGroupName, vmScaleSetName, instanceId);
        console.log(result);
    });
}
 ...
 */
function virtualMachineScaleSetVMSDeallocateMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const resourceGroupName = "rgcompute";
        const vmScaleSetName = "aaaaaaaaaaaaaaaaaaaaaaaa";
...
//# sourceMappingURL=virtualMachineScaleSetVMSDeallocateSample.js.map