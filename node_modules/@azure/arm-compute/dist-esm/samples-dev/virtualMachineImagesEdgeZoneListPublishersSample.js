 ...
 */
function virtualMachineImagesEdgeZoneListPublishersMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineImagesEdgeZone.listPublishers(location, edgeZone);
        console.log(result);
    });
}
 ...
 */
function virtualMachineImagesEdgeZoneListPublishersMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "{subscription-id}";
        const location = "aaaa";
...
//# sourceMappingURL=virtualMachineImagesEdgeZoneListPublishersSample.js.map