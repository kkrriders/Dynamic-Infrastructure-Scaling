...
export class DiskAccessesImpl {
    ...
    listPrivateEndpointConnectionsPagingPage(resourceGroupName, diskAccessName, options) {
        return __asyncGenerator(this, arguments, function* listPrivateEndpointConnectionsPagingPage_1() {
            let result = yield __await(this._listPrivateEndpointConnections(resourceGroupName, diskAccessName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listPrivateEndpointConnectionsPagingAll(resourceGroupName, diskAccessName, options) {
        return __asyncGenerator(this, arguments, function* listPrivateEndpointConnectionsPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = __asyncValues(this.listPrivateEndpointConnectionsPagingPage(resourceGroupName, diskAccessName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    beginCreateOrUpdate(resourceGroupName, diskAccessName, diskAccess, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, diskAccessName, diskAccess, options }, createOrUpdateOperationSpec);
    ...
    beginUpdate(resourceGroupName, diskAccessName, diskAccess, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, diskAccessName, diskAccess, options }, updateOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    beginDelete(resourceGroupName, diskAccessName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, diskAccessName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
