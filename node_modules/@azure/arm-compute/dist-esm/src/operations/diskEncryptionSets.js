...
export class DiskEncryptionSetsImpl {
    ...
    listAssociatedResourcesPagingPage(resourceGroupName, diskEncryptionSetName, options) {
        return __asyncGenerator(this, arguments, function* listAssociatedResourcesPagingPage_1() {
            let result = yield __await(this._listAssociatedResources(resourceGroupName, diskEncryptionSetName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listAssociatedResourcesPagingAll(resourceGroupName, diskEncryptionSetName, options) {
        return __asyncGenerator(this, arguments, function* listAssociatedResourcesPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = __asyncValues(this.listAssociatedResourcesPagingPage(resourceGroupName, diskEncryptionSetName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
