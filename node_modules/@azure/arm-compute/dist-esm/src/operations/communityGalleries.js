...
export class CommunityGalleriesImpl {
    /**
    ...
    get(location, publicGalleryName, options) {
        return this.client.sendOperationRequest({ location, publicGalleryName, options }, getOperationSpec);
    }
}
...
//# sourceMappingURL=communityGalleries.js.map