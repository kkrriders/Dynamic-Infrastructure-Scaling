...
export declare type CapacityReservation = Resource & {
...
export declare type CapacityReservationGroup = Resource & {
...
export declare type CapacityReservationGroupUpdate = UpdateResource & {
    /**
     * A list of all capacity reservation resource ids that belong to capacity reservation group.
     * NOTE: This property will not be serialized. It can only be populated by the server.
     */
...
export declare type CapacityReservationUpdate = UpdateResource & {
    /** SKU of the resource for which capacity needs be reserved. The SKU name and capacity is required to be set. Currently VM Skus with the capability called 'CapacityReservationSupported' set to true are supported. Refer to List Microsoft.Compute SKUs in a region (https://docs.microsoft.com/rest/api/compute/resourceskus/list) for supported values. */
    sku?: Sku;
    /**
     * A unique id generated and assigned to the capacity reservation by the platform which does not change throughout the lifetime of the resource.
...
export declare type CommunityGallery = PirCommunityGalleryResource & {};

/** Specifies information about the gallery image definition that you want to create or update. */
export declare type CommunityGalleryImage = PirCommunityGalleryResource & {
...
export declare type CommunityGalleryImageVersion = PirCommunityGalleryResource & {
...
export declare type DedicatedHostInstanceViewWithName = DedicatedHostInstanceView & {
    /**
...
export declare type DiskAccess = Resource & {
...
export declare type DiskRestorePoint = ProxyOnlyResource & {
    /**
...
export declare type PirSharedGalleryResource = PirResource & {
...
export declare type RestorePointCollection = Resource & {
...
export declare type RestorePointCollectionUpdate = UpdateResource & {
    /** The properties of the source resource that this restore point collection is created from. */
    source?: RestorePointCollectionSourceProperties;
    /**
     * The provisioning state of the restore point collection.
...
export declare type SharedGallery = PirSharedGalleryResource & {};

/** Specifies information about the gallery image definition that you want to create or update. */
export declare type SharedGalleryImage = PirSharedGalleryResource & {
    /** This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. <br><br> Possible values are: <br><br> **Windows** <br><br> **Linux** */
    osType?: OperatingSystemTypes;
    /** This property allows the user to specify whether the virtual machines created under this image are 'Generalized' or 'Specialized'. */
    osState?: OperatingSystemStateTypes;
...
/** Specifies information about the gallery image version that you want to create or update. */
export declare type SharedGalleryImageVersion = PirSharedGalleryResource & {
    /** The published date of the gallery image version Definition. This property can be used for decommissioning purposes. This property is updatable. */
    publishedDate?: Date;
    /** The end of life date of the gallery image version Definition. This property can be used for decommissioning purposes. This property is updatable. */
    endOfLifeDate?: Date;
...
export declare type VirtualMachineExtension = ResourceWithOptionalLocation & {
...
export declare type VirtualMachineRunCommand = Resource & {
...
/** Describes a Virtual Machine run command. */
export declare type VirtualMachineRunCommandUpdate = UpdateResource & {
    /** The source of the run command script. */
    source?: VirtualMachineRunCommandScriptSource;
    /** The parameters used by the script. */
    parameters?: RunCommandInputParameter[];
...
export declare interface VirtualMachineScaleSetIdentityUserAssignedIdentitiesValue {
    /**
     * The principal id of user assigned identity.
     * NOTE: This property will not be serialized. It can only be populated by the server.
     */
...
export declare type VirtualMachineScaleSetVMExtension = SubResourceReadOnly & {
    /**
     * The name of the extension.
     * NOTE: This property will not be serialized. It can only be populated by the server.
     */
...
/** Describes a VMSS VM Extension. */
export declare type VirtualMachineScaleSetVMExtensionUpdate = SubResourceReadOnly & {
    /**
     * The name of the extension.
     * NOTE: This property will not be serialized. It can only be populated by the server.
     */
